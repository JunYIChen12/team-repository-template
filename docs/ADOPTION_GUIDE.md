...
- [ ] 在开发任务开始前阅读[开发前置门禁、测试与验收规范](DEVELOPMENT_READINESS.md)，并在 Issue 中填写开发准备回执。
...
项目应在开发流程中引用 `docs/DEVELOPMENT_READINESS.md`，并在每个功能 Issue 中保留“开发准备回执”。规范正文建议通过中心链接引用；如果项目需要离线使用或需要项目特有条款，可以通过独立 PR 复制并扩展，但不得删除原有强制门禁。
